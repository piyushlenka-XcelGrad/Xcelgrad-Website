...
import React, { useState, useEffect, useRef } from 'react';
import { User, Briefcase, GraduationCap, FileText, LayoutDashboard, Loader2, ChevronRight } from 'lucide-react';
import toast, { Toaster } from 'react-hot-toast';
import { useNavigate } from 'react-router-dom';
import api from '../../api';
          ...
          <div className="flex-1 bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-200">
            ...
            {activeTab === 'background' && (
               <BackgroundTab 
                 ...
                 setNewEdu={setNewEdu} setNewExp={setNewExp}
                 setEditingEduId={setEditingEduId} setEditingExpId={setEditingExpId}
                 setIsEduModalOpen={setIsEduModalOpen} setIsExpModalOpen={setIsExpModalOpen}
               />
            )}
          </div>
        </div>
